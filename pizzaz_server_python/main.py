"""Pizzaz demo MCP server implemented with the Python FastMCP, and mcp-agent cloud (hosting).
...
app = MCPApp(name="pizzaz", description="Serving up hot pizzas", mcp=mcp)
